...
| ATProcessorParam      | List of parameters for verifying access token. See [here](./option.go) for details of the options that can be specified. | verify cert thumbprint: enable, cert backdate duration: 1 hours, cert offset duration: 1 hours. | No       |                        |
