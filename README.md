...
| Transport                        | The HTTP transport for connecting to Athenz server                                           | http\.Client\{ Timeout: 30 \* time\.Second \}        | No       | http\.DefaultTransport |
| CacheExp                         | The TTL of the success cache                                                                 | 1 Minute                                             | No       | 1 \* time\.Minute      |
| EnablePubkeyd/DisablePubkeyd     | Run public key daemon or not                                                                 | true                                                 | No       |                        |
...
| EnablePolicyd/DisablePolicyd     | Run policy daemon or not                                                                     | true                                                 | No       |                        |
...
| EnableJwkd/DisableJwkd           | Run JWK daemon or not                                                                        | true                                                 | No       |                        |
...
| AccessTokenParam                 | Use access token verification\. See \[AccessTokenParam\]\(\#accesstokenparam\) for details\. | Same as \[AccessTokenParam\]\(\#accesstokenparam\)\. | No       | \{\}                   |
| EnableRoleToken/DisableRoleToken | Use role token verification or not                                                           | true                                                 | No       |                        |
| RoleAuthHeader                   | The HTTP header to extract role token                                                        | Athenz\-Role\-Auth                                   | No       | "Athenz\-Role\-Auth"   |
| EnableRoleCert/DisableRoleCert   | Use role certificate verification or not                                                     | true                                                 | No       |                        |
